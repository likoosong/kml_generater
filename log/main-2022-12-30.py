...
class MainUi(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.tour_point_around_widget = QtWidgets.QWidget()        # 创建右侧部件
        self.tour_point_around_widget.setObjectName('right_widget')
        self.right_tour_point_around_layout = QtWidgets.QGridLayout()
        self.tour_point_around_widget.setLayout(self.right_tour_point_around_layout)   # 设置右侧部件布局为网格

        self.tour_point_around_widget.setStyleSheet(
            '''
                QWidget#right_widget{
                    color:#232C51;
                    background:white;
        ...
        self.main_layout.addWidget(self.tour_point_around_widget, 0, 2, 12, 10)  # 右侧部件在第0行第3列，占8行9列
        self.tour_point_around_widget.hide()
        ...
        self.left_label_1 = QtWidgets.QPushButton("坐标环绕")
        ...
        self.left_button_3 = QtWidgets.QPushButton(qtawesome.icon('fa.film',color='white'),"圆圈环饼")
        ...
        self.left_layout.addWidget(self.left_button_1, 3, 0, 1, 3)   # 环绕浏览
        self.left_layout.addWidget(self.left_button_2, 2, 0, 1, 3)   # 四顾浏览
        ...
        # self.right_bar_layout.addWidget(self.right_bar_widget_point_progressBar, 10, 1, 4, 7)
        ...
        self.right_tour_point_around_layout.addWidget(self.right_bar_point_around_widget, 2, 0, 1, 9)  # 右侧左边环绕浏览
    ...
    def on_left_widget_button_clicked(self, value):
        ...
        if left_sender == '环绕浏览':
            ...
            self.tour_point_around_widget.show()
            pass
