...
class TourLineArount(object):
    ...
    def tour_line_arount_play(self, kmlname, coords, length=0, distance=0, tour_time=30):
        ...
        for idx, coord in enumerate(coords):
            ...
            if point_idx * 2 == idx:  # 第三次
                ...
                flyto.lookat.heading = 259.23256333335
            ...
            if point_idx * 3 == idx:
                ...
                flyto.lookat.heading = 244.46291021954
                flyto.lookat.range = distance / 3
                # flyto.lookat.AltitudeMode = 'relativeToGround'
            ...
            if point_idx * 5 == idx:
                ...
                flyto.lookat.heading = 261.35557928933
                flyto.lookat.range = distance / 3
                # flyto.lookat.AltitudeMode = 'relativeToGround'
            ...
            if point_idx * 9 == idx:
                ...
                flyto.lookat.latitude = latitude
                flyto.lookat.altitude = 0
                flyto.lookat.tilt = 30

                flyto.lookat.heading = 349.38615732466
                flyto.lookat.range = distance / 2
                # flyto.lookat.AltitudeMode = 'relativeToGround'
            ...
            if point_idx * 13 == idx:
                ...
                flyto.lookat.heading = 77.416735359993
                flyto.lookat.range = distance / 4
                # flyto.lookat.AltitudeMode = 'relativeToGround'
            ...
            if point_idx * 15 == idx:
                ...
                flyto.lookat.heading = 19.717948789817
                flyto.lookat.range = distance / 3
                # flyto.lookat.AltitudeMode = 'relativeToGround'
            ...
            if point_idx * 17 == idx:
                ...
                flyto.lookat.heading = 5.5122646908788
                flyto.lookat.range = distance / 3
                # flyto.lookat.AltitudeMode = 'relativeToGround'
            ...
            if point_idx * 18 == idx:
                ...
                flyto.lookat.heading = 11.404796311623
                flyto.lookat.range = distance / 3
                # flyto.lookat.AltitudeMode = 'relativeToGround'
    ...
    def tour_line_arount_change(self, kmlname, coords, length=0, distance=0, tour_time=30):
    ...
    def tour_line_arount(self, kmlname, coords, length=0, distance=0, tour_time=30):
        self.tour_line_arount_change(kmlname, coords, length, distance, tour_time)
        self.tour_line_arount_play(kmlname, coords, length, distance, tour_time)
...
if __name__ == '__main__':
    ...
    xml_name = '/Users/python/Desktop/maps/kmlname_generater/utlis/北京-郑州.xml'
    ...
    for idx, coord in enumerate(coords):
        ...
        distance += dte
    TourLineArount(kmlname).tour_line_arount(kmlname, coords, length=length, distance=distance, tour_time=30)
